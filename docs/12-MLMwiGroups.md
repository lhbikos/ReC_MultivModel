...
![](12-MLMwiGroups_files/figure-docx/unnamed-chunk-6-1.png)<!-- -->
...
```r
sjPlot::plot_model(Level2, type = "pred", terms = c("AttendL1", "Homogeneity",
    "AttendL2"))
```
